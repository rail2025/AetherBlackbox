...
namespace AetherBlackbox.Windows
{
    public partial class MainWindow
    {
        private void DrawInteractiveLog()
        {
            ...
            {
                if (showTimeCol) ImGui.TableSetupColumn("Time", ImGuiTableColumnFlags.WidthFixed);
                if (showHpCol) ImGui.TableSetupColumn("HP", ImGuiTableColumnFlags.WidthFixed);
                if (showSourceCol) ImGui.TableSetupColumn("Source", ImGuiTableColumnFlags.WidthFixed);
